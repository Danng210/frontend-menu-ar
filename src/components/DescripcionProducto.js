...
export default function DescripcionProducto() {
  ...
  const modelos = {
    Papas_Bravas: "/modelos/patatas_bravas.glb",
    ...
    Donburi_de_Pollo_en_Salsa_Teriyaki: "/modelos/donburi.glb",
    Naan_ChocoLovers: "/modelos/naan.glb",
    Tiramisú_Clásico: "/modelos/tiramisu.glb"
  };
  const escalas = {
    Papas_Bravas: "20 20 20",
    Gyozas_de_Cerdo_y_Vegetales: "6 4 3",
    Filete_Campo_Gourmet: "2 2 2",
    Enchiladas_Norteñas_de_Res: "4 4 4",
    Pollo_gratinado: "3 3 3",
    Donburi_de_Pollo_en_Salsa_Teriyaki: "3 3 3",
    Naan_ChocoLovers: "1 1 1",
    Tiramisú_Clásico: "0.03 0.03 0.03"
  };
  ...
  <div className={`menu ${isOpen ? 'open' : ''}`}>
    <div className="descripcion-producto">
      ...
      <p id="precio-en-tarjeta"><stbrong>Precio:</stbrong> ${producto.PRECIO} COP</p>
